...
sources:
    ...
    ***                                                                             ***
        термин - проксирование
        клиент делает запрос web серверу, а web сервер (frontend-серверу) проксирует,
        передаёт запрос дальше - application серверу (backend-серверу)
    ***                                                                             ***
...
- If-Modified-Since
    ...
    (на самом деле когда этот файл был полследний раз изменён)
